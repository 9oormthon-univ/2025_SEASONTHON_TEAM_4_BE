...
class Settings:
    ...
    RAG_MODEL_NAME = os.getenv('RAG_MODEL_NAME', 'jhgan/ko-sroberta-multitask')
    RAG_CACHE_DIR = os.getenv('RAG_CACHE_DIR', 'app/cache/rag')
    RAG_SIMILARITY_THRESHOLD = float(os.getenv('RAG_SIMILARITY_THRESHOLD', '0.6'))
    RAG_BATCH_SIZE = int(os.getenv('RAG_BATCH_SIZE', '10'))  # 배치 크기 설정
